...
# run the scipt
python ./scripts/data_validation.py --raw_train_path './data/raw/train.csv' --raw_test_path './data/raw/test.csv' --val_train_path './data/val/' --val_test_path './data/val/'
"""
...
@click.command()
@click.option('--raw_train_path', 
                type=click.Path(exists=True, dir_okay=False, file_okay=True, readable=True),
                help='File path to the raw training data')
@click.option('--raw_test_path', 
                type=click.Path(exists=True,  dir_okay=False, file_okay=True, readable=True),
                help='File path to the raw testining data')
@click.option('--val_train_path', 
                type=click.Path(exists=True, dir_okay=True, file_okay=False, writable=True),
                help='Directory path to the validated and split training data')
@click.option('--val_test_path', 
                type=click.Path(exists=True, dir_okay=True, file_okay=False, writable=True),
                help='Directory path to the validated and split testining data')
