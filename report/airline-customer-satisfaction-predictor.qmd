...
This study aims to create a reliable predictive model that will predict US airline passenger satisfaction with high performance.
...
Adecision tree classifier was trained to achieve a nonlinear separation between the classes.
