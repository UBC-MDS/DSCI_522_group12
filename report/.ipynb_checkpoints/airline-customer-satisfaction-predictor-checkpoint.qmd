...
![Distribution of Customer Satisfaction Levels](../results/target_variable_distribution.png)

![Heatmap of Correlations Between Predictors for Airline Customer Satisfaction Dataset](../results/correlation_matrix.png)

![Density Plots of Numeric Features by Customer Satisfaction Levels](../results/numeric_feat_target_plots.png)
